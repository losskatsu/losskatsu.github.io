...
전자와 같이 행렬 2개로 놓고 보았을 때 행공간의 차원은 2입니다. 
그리고 후자와 같이 행렬 3개로 놓고 보았을 때 열공간의 차원은 3이죠.
이 때, 어떤 행렬 A의 랭크는 행공간의 차원과 열공간의 차원 중 작은 쪽을 의미하며 아래와 같이 표현합니다. 

$$ rank(A) = min(행공간의 차원, 열공간의 차원) $$ 

그럼 위 예제에서의 랭크는 얼마일까요?
<br />
