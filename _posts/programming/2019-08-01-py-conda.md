...
(py3_7_6) C:\WINDOWS\system32>pip install torch torchvision torchaudio   (파이토치 CPU버전)
...
(py3_7_6) C:\WINDOWS\system32>pip install django
...
```bash
(base) C:\WINDOWS\system32>conda activate py3_7_6
(py3_7_6) C:\WINDOWS\system32>pip install jupyter
