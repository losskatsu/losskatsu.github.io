...
$$Q_t(a) \doteq \frac{sum of rewards when a taken prior to t}{number of times a taken prior to t} = \frac{\sum_{i=1}^{t-1}R_i \dot \mathbb{1}_{A_{i}=a}}{\sum_{i=1}^{t-1} \mathbb{1}_{A_{i}=a}}$$
