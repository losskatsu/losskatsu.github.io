...
$$Q_t(a) \doteq \frac{\texttt{sum of rewards when a taken prior to t}}{\texttt{number of times a taken prior to t}} = \frac{\sum_{i=1}^{t-1}R_i \dot I_{A_{i}=a}}{\sum_{i=1}^{t-1} I_{A_{i}=a}}$$
